...
const SIGNAL_STRENGTH_MAP = `## Candidate Signal-to-Strength Mapping
 ...
 */
export function buildRecheckPrompt(job: JobWithCompany): string {
...
{"id": ${job.id}, "score_success": <1.0-10.0>, "daily_work_summary": "<1 sentence: what this person does day-to-day>", "must_haves_match": ["<matched must-have 1>", ...], "must_haves_gap": ["<unmatched must-have 1>", ...], "reason": "<1-2 sentences explaining the score>"}
`;
}
